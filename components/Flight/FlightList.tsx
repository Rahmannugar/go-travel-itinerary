...
const FlightList = () => {
  ...
  return (
    <ul className="flex gap-6 items-center">
      <li className="bg-white rounded h-[200px] md:h-[274px] w-full flex justify-between items-start">
        ...
        <div className="bg-custom-red cursor-pointer hover:bg-custom-red-hover duration-300 transition-colors ease-in-out flex w-[46px] justify-center items-center h-full">
          <DeleteIcon />
        </div>
      </li>
    </ul>
